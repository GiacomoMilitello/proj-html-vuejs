    ...
    <div id="book" class="p-5 d-flex align-items-center justify-content-center">
        <div class="width-one input-group my-5">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="#">1 Person</a></li>
                <li><a class="dropdown-item" href="#">2 People</a></li>
                <li><a class="dropdown-item" href="#">3-4 People</a></li>
                <li><a class="dropdown-item" href="#">5-10 People</a></li>
                <li><a class="dropdown-item" href="#">11+ People</a></li>
        ...
        <button class="btn-orange my-5">BOOK A TABLE</button>
    </div>
</template>
