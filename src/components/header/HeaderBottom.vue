...
export default {
  ...
  data() {
        return {
            ad: [
                { img : 'src/img/h3-img-1.jpg' },
                { img : 'src/img/h3-img-2.jpg' },
